...
ALPINE_DEC=quay.io/jitesoft/alpine:dec
ALPINE_ENC_EXPORT_NAME=alpine.enc
ALPINE_ENC_IMPORT_BASE=quay.io/jitesoft/alpine

NGINX=quay.io/nginx/nginx-unprivileged:latest
NGINX_ENC=quay.io/nginx/nginx-unprivileged:enc
NGINX_DEC=quay.io/nginx/nginx-unprivileged:dec

BASH=cgr.dev/chainguard/bash:latest
BASH_ENC=cgr.dev/chainguard/bash:enc
